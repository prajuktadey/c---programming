...
/*and so as i loop through the cards i check each one
and if it matches one of the enums which is being used as
a constant, then i can print out that particular string.*/